...
Section 2 — Patient Details
  ...
  • Medical Record Number (optional, auto-incremented display)
...
a WebView (expo-web-browser or react-native-webview) showing:
  ...
  • Date + "Prescription generated by PallGerix" footer
...
══════════════════════════════════════════════════════════════════
  ...
  • Card shows: patient name, date, doctor name, diagnosis preview.
