...
├── css/
│   └── pg-rx-style.css            ← All styles (screen + @media print)
├── js/
│   └── pg-rx-app.js               ← All application logic (vanilla JS)
├── data/
│   ├── pg-rx-doctor.json          ← Doctor and clinic profiles (array)
│   ├── pg-rx-medicines.json       ← Medicine template library
│   ├── pg-rx-tests.json           ← Predefined test names
│   ├── pg-rx-careplans.json       ← Predefined care plan options
│   ├── pg-rx-vitals-standards.json ← Clinical classification thresholds
│   └── pg-rx-icd-11-code.json     ← ICD-11 diagnosis code library (292 entries)
├── assets/
...
### 1. Doctors — `data/pg-rx-doctor.json`
...
- Update `signatureFile` in `pg-rx-doctor.json` to match the filename

### 3. Medicine Templates — `data/pg-rx-medicines.json`
...
### 5. Care Plans — `data/pg-rx-careplans.json`
...
### 6. ICD-11 Diagnosis Library — `data/pg-rx-icd-11-code.json`
...
### 7. Vitals Classification Thresholds — `data/pg-rx-vitals-standards.json`
